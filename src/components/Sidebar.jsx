...
export default function Sidebar({ activeMenu, setActiveMenu, isSidebarOpen, setIsSidebarOpen }) {
  const menus = [
    { id: 'dashboard', label: 'Dashboard', icon: 'M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z' },
    { id: 'hr', label: 'HR Division', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z' },
  ...
  return (
    <div className={`h-full bg-[#0f172a] border-r border-slate-800/50 flex flex-col transition-all duration-300 shrink-0 relative ${isSidebarOpen ? 'w-64' : 'w-20'}`}>
      ...
      {/* TOMBOL BUKA-TUTUP (TOGGLE) - INI YANG BIKIN BISA DIKLIK */}
      <button 
